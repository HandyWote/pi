...
```bash
npm install -g --ignore-scripts @handy_wote/pi-coding-agent
```
...
- [@handy_wote/pi-ai](https://www.npmjs.com/package/@handy_wote/pi-ai): Core LLM toolkit
- [@handy_wote/pi-agent-core](https://www.npmjs.com/package/@handy_wote/pi-agent-core): Agent framework
- [@handy_wote/pi-tui](https://www.npmjs.com/package/@handy_wote/pi-tui): Terminal UI components
