...
import type { AssistantMessage, Model } from "@handy_wote/pi-ai";
...
vi.mock("@handy_wote/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@handy_wote/pi-ai/compat")>();
	return {
		...actual,
