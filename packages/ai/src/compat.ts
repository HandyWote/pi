 ...
 *
 * Existing apps switch imports from "@handy_wote/pi-ai" to
 * "@handy_wote/pi-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@handy_wote/pi-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@handy_wote/pi-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@handy_wote/pi-ai/providers/all" or `Models.getProviders()`. */
