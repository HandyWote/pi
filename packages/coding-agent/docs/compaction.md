...
For TypeScript definitions in your project, inspect `node_modules/@handy_wote/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@handy_wote/pi-coding-agent";
