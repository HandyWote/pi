...
**Source:** [`@handy_wote/pi-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@handy_wote/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@handy_wote/pi-tui";
...
Import from `@handy_wote/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@handy_wote/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@handy_wote/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@handy_wote/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@handy_wote/pi-coding-agent";
import { Markdown } from "@handy_wote/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@handy_wote/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@handy_wote/pi-coding-agent";
import { DynamicBorder } from "@handy_wote/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@handy_wote/pi-tui";
...
```typescript
import { BorderedLoader } from "@handy_wote/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@handy_wote/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@handy_wote/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@handy_wote/pi-tui";
...
import { matchesKey, truncateToWidth } from "@handy_wote/pi-tui";
