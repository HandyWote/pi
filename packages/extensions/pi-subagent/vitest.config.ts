...
export default {
	...
	resolve: {
		alias: {
			...
			"@earendil-works/pi-coding-agent": fileURLToPath(new URL("./test/mocks/coding-agent.ts", import.meta.url)),
			"@handy_wote/pi-tui": fileURLToPath(new URL("../../tui/src/index.ts", import.meta.url)),
			"@earendil-works/pi-tui": fileURLToPath(new URL("../../tui/src/index.ts", import.meta.url)),
		},
	},
};
