...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@handy_wote/pi-coding-agent";
...
```bash
npm install @handy_wote/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@handy_wote/pi-coding-agent";
...
The `Agent` class (from `@handy_wote/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@handy_wote/pi-ai";
import { ModelRuntime } from "@handy_wote/pi-coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@handy_wote/pi-ai";
import { createAgentSession, ModelRuntime } from "@handy_wote/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@handy_wote/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@handy_wote/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@handy_wote/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@handy_wote/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@handy_wote/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@handy_wote/pi-coding-agent";
