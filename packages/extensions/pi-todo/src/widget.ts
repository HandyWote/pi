import type { ExtensionContext, ExtensionWidgetOptions } from "@handy_wote/pi-coding-agent";
import type { TodoStore } from "./store.ts";
import type { TodoItem } from "./types.ts";

const BAR_WIDTH = 10;
const WIDGET_KEY = "pi-todo";
const TODO_WIDGET_OPTIONS = { placement: "aboveStatus" } as unknown as ExtensionWidgetOptions;
...
export function updateTodoWidget(ctx: ExtensionContext, store: TodoStore): void {
	...
	ctx.ui.setWidget(WIDGET_KEY, lines, TODO_WIDGET_OPTIONS);
}
