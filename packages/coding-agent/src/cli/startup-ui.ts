import { ProcessTerminal, setCapabilityOverrides, setKeybindings, type TUI, TuiMainScreen } from "@handy_wote/pi-tui";
...
const OFFICIAL_PACKAGE_NAME = "@handy_wote/pi-coding-agent";
